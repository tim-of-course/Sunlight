...
use sunlight_core::execution::{
    ...
    promotion_authored_context_id, ExecutionFoundationError, ExecutionOutputPromotionRecord,
    ExecutionOutputPromotionProvenanceRef, ExecutionRecord, OutputClassification, OutputKind,
