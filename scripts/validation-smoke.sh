...
out="$(run_ok project-compat sun project materialize --view "$view_id" --purpose compatibility --fixture basic-app --json)"
assert_contains "$out" '"projection_id":"projection_compat_agent_a_0001"' "compat projection id"
assert_contains "$out" '"writable_policy":"writable_with_explicit_import"' "compat projection policy"
