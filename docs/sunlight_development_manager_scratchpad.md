...
| repo-backed-compat-import | Windows direct | `C:\Users\TimothyCardoza\Documents\AI-Apps\Sunlight 2` on `main` | Next | Implement no-fixture compatibility project/diff/import from real projections into native operations. | Prepared WSL branch is retired; resume this slice directly in the Windows checkout. |
