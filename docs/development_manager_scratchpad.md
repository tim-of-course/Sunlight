...
- Active slice `projection-manifest-executable-fixture`: WSL clone `/home/timothycard/code/Sunlight-2-projection-manifest-executable-fixture-20260704-125528`, branch `dm/projection-manifest-executable-fixture`, run artifacts under `C:\tmp\sunlight-manager\20260704-125528`.
...
- Projection manifest invalid/stale/root-mismatch behavior after executable-bit verification lands.
