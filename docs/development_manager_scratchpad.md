...
- Next useful slices: continue Phase 6 compatibility import hardening, likely stale projection/session CLI preconditions or broader external validation refresh after docs alignment.
