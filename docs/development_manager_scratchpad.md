...
- Next useful slices: continue Phase 6 compatibility import coverage, likely rename-plus-edit semantics or multi-operation follow-up after metadata-only coverage.
